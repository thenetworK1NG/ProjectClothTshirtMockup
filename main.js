...
function updateTexture() {
    ...
    if (images.length > 0) {
        // Draw all images on the image canvas
                ...
                <div class="template-grid">
                    ${Array.from({length: 17}, (_, i) => `
                        <div class="template-item" data-template="${i + 1}.png">
                            <img src="templates/${i + 1}.png" alt="Template ${i + 1}" loading="lazy">
                            <div class="template-preview">
                                <img src="templates/${i + 1}.png" alt="Template ${i + 1} Preview">
                            </div>
                        </div>
                    `).join('')}
                </div>
