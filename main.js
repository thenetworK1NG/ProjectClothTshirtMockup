        ...
        <div class="render-controls">
            <div class="control-group">
                ...
                <div class="project-controls">
                    <button id="import-project" class="project-btn">
                        <span class="project-icon">📥</span>
                        Import Project
                    </button>
                    <input type="file" id="project-input" accept="image/*" style="display: none;">
                </div>
            </div>
            <div class="control-group">
...
projectInput.addEventListener('change', (e) => {
    ...
    reader.onload = (e) => {
        const img = new Image();
        img.onload = () => {
            // Create a new image object that matches template.png size and position
            const newImage = {
                image: img,
                url: e.target.result,
                transform: {
                    x: 0, // Center position like template
                    y: 0,
                    scale: 1, // Use template scale
                    rotation: 0,
                    stretchWidth: 1,
                    stretchHeight: 1
                }
